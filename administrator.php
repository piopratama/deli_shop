	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<a href="stock_history.php"><button type="button" class="btn btn-default" id="undirectpayMenu" style="height:170px; background-color:#cbbca9">Stock History <span style="color:red;font-size:12px; border:none;">(coming soon)</span></button></a>
				</div>
				<div class="col-md-2"></div>
			</div>
			<!--<div class="row">
