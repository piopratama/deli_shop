...
(2,'OLIVE OIL EXTRA VIRGIN (REFILL)',140000,0,'LITER',5,0),
(3,'OLIVE OIL EXTRA VIRGIN 1 LITER ',195000,0,'LITER',5,0),
(4,'CREAM CHEESE NEUFCHATEL 250GR ',68000,0,'PCS',1,0),
(5,'SOUR CREAM 250GR \"YUMMY\"',48000,1,'PCS',1,0),
...
(26,'CHICKEN SAUSAGE (ITALIAN RECIPE)',210000,0.455,'KG',6,0),
...
(24,'2019-01-22','2019-01-22 14:49:004',10000,0,'cash'),
(25,'0000-00-00','2019-01-22 14:49:004',0,51200,'transfer'),
(26,'2019-01-23','2019-01-23 00:06:384',10000,0,'cash'),
(27,'0000-00-00','2019-01-23 00:06:384',0,38000,'transfer');
...
/*Table structure for table `tb_expired` */

DROP TABLE IF EXISTS `tb_expired`;
...
/*Data for the table `tb_expired` */

insert  into `tb_expired`(`id`,`id_item`,`qty`,`expired_date`) values 
(1,5,1,'2019-01-25 00:00:00');
...
(15,'2019-01-22 14:49:004','pio','2019-01-22 14:49:00',4,4,1,10,61200,'',1),
(16,'2019-01-23 00:06:384','pio','2019-01-23 00:06:38',4,5,1,0,48000,'',1);
